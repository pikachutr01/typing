...
export function MetricStrip({
  ...
  return (
    <section className="sticky top-[237px] z-10 grid gap-2 bg-slate-50/95 py-2 backdrop-blur transition-colors duration-200 dark:bg-slate-950/95 sm:top-[189px] sm:grid-cols-2 md:top-[185px] lg:top-[65px] lg:grid-cols-2">
      {metrics.map((metric) => {
